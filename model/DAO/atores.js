...
const selectAtoresByIdFilme =  async function(id){    
    try {
    // Realiza a busca do filme pelo ID
    let sql = `select * from tbl_atores join tbl_ator_filme on tbl_atores.id = tbl_ator_filme.id_ator where tbl_ator_filme.id_filme = ${id}`
