...
// *************************** Imports de arquivos e bibliotecas ************************************ //
    ...
    const controllerGenero = require('./controller/controller_generos.js')
...
app.post('/v3/acmefilmes/postdiretor', cors(), bodyParserJSON, async function(request, response, next){
